...
function TcpFlow(src, sport, dst, dport, sFlags, dFlags) {
...
function TcpNetFlow(src, sport, dst, dport, flags) {
...
function parsePacket(pckt) {
    if(pckt.prot == TCP) {
        return new TcpNetFlow(pckt.srcaddr, pckt.srcport, pckt.dstaddr, pckt.dstport, pckt.tcp_flags);
    }
}
